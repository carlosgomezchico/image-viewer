...
public class SwingImageDisplay extends JPanel implements ImageDisplay {
    ...
    private static class Resizer {
        ...
        public Dimension resize(Dimension imageDimension) {
            double widthRatio = dimension.getWidth() / imageDimension.getWidth();
            double heightRatio = dimension.getHeight() / imageDimension.getHeight();
            double ratio = Math.min(widthRatio, heightRatio);
            return new Dimension((int) (imageDimension.width * ratio), (int) (imageDimension.height * ratio));
        }
    }
}
